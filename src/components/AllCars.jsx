...
export default function AllCars({ setPage, setCarId }) {
        ...
        <>
            ...
            <div className=" p-4 px-4">
                ...
                <div className=" text-center bg-gradient-to-r from-slate-300 to-slate-500 py-2 px-4 rounded-lg opacity-90">
                    <p className="text-white">Explore our collection of high-performance supercars</p>
                </div>
                
                
                <div className="flex overflow-x-auto w-full mt-4 border-4 border-fuchsia-600 ">
                    <div className="w-full ">
                        <div className="inline-block min-w-full  sm:px-2 lg:px-8 ">
                            <div className="overflow-x-auto flex justify-center h-[83vh] overflow-y-scroll">
