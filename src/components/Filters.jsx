        ...
        --> */}
                                    <div class="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl ">
                                        <div class="flex items-center justify-between px-4">
                                            ...
                                            <button type="button" onClick={setMF} class="-mr-2  flex h-10 w-10 items-center  justify-center rounded-md bg-white p-2 text-gray-400 ">
                                                <span class="sr-only border border-red-500">Close menu</span>
                                            ...
                                            <ul role="list" class="px-2 py-3 font-medium text-gray-900 h-[400px] overflow-y-scroll">
...

                                                {
                                                    makers.length > 0
                                                        ...
                                                        makers.map(element =>
                                                            <li>
                                                                <a class="block px-2 py-2">{element}</a>
                                                            </li>)
                                                        : <Empty />
                                                }
                                            </ul>
                    ...
                    <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
                        <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24 ">
                            <h1 class="text-4xl font-bold tracking-tight text-gray-900">Choices</h1>
                ...
                --> */}
                        ...
                        <section aria-labelledby="products-heading" class="pb-24 pt-6 ">
                            ...
                            <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                                    ...
                                    <ul role="list" class="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-gray-900  h-[400px] overflow-y-scroll">
                                        {
                                            makers.length > 0
                                                ...
                                                makers.map(element =>
                                                    <li>
                                                        <a class="block px-2 py-1">{element}</a>
                                                    </li>)
                                                : <Empty />
                                        }
                                    </ul>
                                ...
                                {/* <!-- Product grid --> */}
                                <div class="lg:col-span-3 border-2 border-fuchsia-500 min-h-[70vh]">
                                    {/* <!-- Your content --> */}
                                </div>
                            </div>
                        </section>
