    ...
    return (
        <div className="w-full  flex flex-col items-center">
            ...
            <div className="rounded-lg px-4 py-2  mt-4 mx-4 mb-6">
                <p className="text-center text-[15px] font-bold text-slate-500">Edit your car ad</p>
            </div>



            <div className="w-full h-[48vh] p-4 flex flex-col items-center justify-start bg-green-600 ">
