...
function App() {
  ...
  return (
    <>
      ...
      {/* <div className="mt-4 flex flex-col py-3 justify-between items-center w-full h-[10vh] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] bg-gradient-to-r from-indigo-900 to-blue-800 lg:h-[10vh]">
